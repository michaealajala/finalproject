...
<form action="index.php?page=accounts&action=register" method="post" >
    ...
    Email(Username): <input type="email" class="form-control" name="email" ><br>
    Phone: <input minlength="10" type="text" class="form-control" name="phone"><br>
    Birthday: <input type="date" class="form-control" name="birthday"><br>
    Gender: <input type="text" class="form-control" name="gender"><br>
    Password: <input minlength="6" type="password" class="form-control" name="password"><br>
